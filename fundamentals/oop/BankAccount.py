class BankAccount:
    ...
    def display_all_accounts(cls):
        for each in cls.all_accounts:
            print(f"account balance: ${each.balance} and interest rate is: {each.rate}%")

user1= BankAccount(0.5, 600)
user1.deposit(50).deposit(25).deposit(25).withdraw(150).yield_interest().display_account_info().display_all_accounts()

user2 = BankAccount( 0.1, 500)
user2.deposit(10).deposit(10).withdraw(50).withdraw(25).withdraw(25).withdraw(50).display_account_info().yield_interest().display_all_accounts()
